...
// NimBLE is not integrated past this stage and is untested
// Remnant code from Espressif's BLE template code, for dev purposes only
...
// Uncomment the following two lines to print all devices that were seen during a scan
...
// Ctrl+F, jump to `BLE GAP FUNCTIONS`
// Ctrl+F, jump to `CONTROLLER INIT`

// Define BT vars & config
...
static void ble_gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_AUTH_CMPL_EVT:
        ...
        {
            // TODO: correct behavior on initial HID error (i.e. if system power cycles and controller doesn't reconnect)
...
// Run with NimBLE instead of Bluedroid, untested and not integrated into the rest of the code.
// This only exists as a remnant of Espressif's bluetooth template code
#if CONFIG_BT_NIMBLE_ENABLED
